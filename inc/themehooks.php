 ...
 */
class slushman_2016_Themehooks {
	...
	private function loader() {
		...
		add_action( 'slushman_2016_header_content', array( $this, 'site_title' ), 10 );
		add_action( 'slushman_2016_header_content', array( $this, 'site_description' ), 15 );
		...
		add_action( 'slushman_2016_footer_content', array( $this, 'footer_content' ) );

		add_action( 'tha_content_top', array( $this, 'breadcrumbs' ) );

		add_action( 'tha_entry_after', array( $this, 'comments' ), 10 );

		add_action( 'slushman_2016_404_before', array( $this, 'four_04_title' ), 10 );

		add_action( 'slushman_2016_404_content', array( $this, 'add_search' ), 10 );
		add_action( 'slushman_2016_404_content', array( $this, 'four_04_posts_widget' ), 15 );
		add_action( 'slushman_2016_404_content', array( $this, 'four_04_categories' ), 20 );
		add_action( 'slushman_2016_404_content', array( $this, 'four_04_archives' ), 25 );
		add_action( 'slushman_2016_404_content', array( $this, 'four_04_tag_cloud' ), 30 );
	 ...
	 * Adds a search form
	 *
	 * @hooked 		slushman_2016_404_content 		15
	 *
	 ...
	 *
	 * @hooked 		slushman_2016_footer_content
	 *
	 ...
	 *
	 * @hooked 		slushman_2016_404_content		25
	 *
	 ...
	 * Adds the  to the 404 page content.
	 *
	 * @hooked 		slushman_2016_404_content		20
	 *
	 * @return 		mixed 							The categories widget
	 */
	public function four_04_categories() {

		if ( ! slushman_2016_categorized_blog() ) { return; }
	 ...
	 * Adds the  to the 404 page content.
	 *
	 * @hooked 		slushman_2016_404_content		30
	 *
	 ...
	 *
	 * @hooked 		slushman_2016_404_content 		10
	 *
	 ...
	 *
	 * @hooked 		slushman_2016_header_content 		15
	 *
	 ...
	 *
	 * @hooked 		slushman_2016_header_content 		10
	 *
